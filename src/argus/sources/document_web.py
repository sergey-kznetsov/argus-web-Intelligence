...
class DocumentAwareGenericWebAdapter(GenericWebAdapter):
    """Generic public-web source with bounded local extraction for binary documents."""

    def __init__(self, *args, pdf_extractor: BoundedPdfExtractor, **kwargs) -> None:
    ...
    async def extract(
        ...
        if fetched.blocked or not self._is_pdf(fetched):
